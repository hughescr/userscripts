...
| --- | --- | --- |
| [bsky-unroller](bsky-unroller/) | Adds an "Unroll thread" link to threaded bsky.app posts that opens the post on tbsky.app. | [Install](https://raw.githubusercontent.com/hughescr/userscripts/main/bsky-unroller/bsky-unroller.user.js) |
